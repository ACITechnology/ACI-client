    ...
    <div className="max-w-7xl mx-auto w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-5 mb-8 items-stretch">
        <Link href="/tickets" className="lg:col-span-2 block">
          <div className="h-full flex flex-col bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-8 text-center hover:border-pink-500/50 hover:bg-white/8 transition group">
